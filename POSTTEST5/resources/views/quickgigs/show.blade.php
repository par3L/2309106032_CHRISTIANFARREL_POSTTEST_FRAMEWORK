    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2">
                    ...
                    <div class="flex items-center space-x-4 mb-6">
                        ...
                        <div>
                            <h3 class="text-white font-semibold text-lg">
                                <a href="{{ route('profile.show', $gig->user->id) }}" class="hover:text-emerald-400 transition-colors">
                                    {{ $gig->user->name }}
                                </a>
                            </h3>
                            <div class="flex items-center space-x-4 text-sm">
                                <div class="flex items-center space-x-1">
                                    ...
                                    <span class="text-gray-400">({{ $gig->reviews()->count() }} reviews)</span>
                                </div>
                                <span class="text-gray-400">{{ $gig->orders()->count() }} orders completed</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    <div class="bg-dark-800 rounded-xl overflow-hidden border border-dark-700">
                        @if($gig->image)
                            <img src="{{ asset('storage/' . $gig->image) }}" alt="{{ $gig->title }}" class="w-full h-96 object-cover">
                        @else
                            <img src="https://source.unsplash.com/1200x800/?{{ urlencode(strtolower($gig->category->name)) }},work,freelance,professional" alt="{{ $gig->title }}" class="w-full h-96 object-cover">
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-dark-800 rounded-xl p-6 border border-dark-700 mb-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-gray-300">Unlimited revisi hingga puas</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <svg class="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
            ...
            <div class="lg:col-span-1">
                <div class="bg-dark-800 rounded-xl border border-dark-700 overflow-hidden sticky top-20">
                    <div class="p-6">
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-gray-300 text-sm">Unlimited revisi</span>
                            </div>
                        </div>
                        <div class="space-y-3">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="text-white">
                                    {{ $gig->reviews()->count() > 0 ? number_format($gig->reviews()->avg('rating'), 1) : 'New' }}/5.0
                                </span>
                            </div>
                        </div>
                    </div>
