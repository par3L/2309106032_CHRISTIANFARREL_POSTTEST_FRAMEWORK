    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2">
                ...
                <div class="mb-8">
                    <div class="bg-dark-800 rounded-xl overflow-hidden border border-dark-700 h-96 flex items-center justify-center">
                        <x-category-icon :category="$gig->category" size="2xl" color="white" />
                    </div>
                </div>
